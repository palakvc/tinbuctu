...
const ClickEffect = ({ pageNum }) => {
  console.log(pageNum);
  useEffect(() => {
    console.log(pageNum, "in effect");
    animate();
  ...
  function animate() {
    ...
    var colorPalette = {
      bg: { r: 12, g: 9, b: 29 },
      matter: [
        { r: 252, g: 178, b: 96 }, // darkPRPL
        { r: 252, g: 178, b: 96 }, // rockDust
    ...
    // Click listener
    // document.body.addEventListener(pageNum, function (event) {
